...
In start-ups, it's commonplace to shift direction at a moments notice. New ideas come and go frequently and it's very important to be able to accommodate change as quickly and effectively as possible. As a result, engineers, designers and product managers are faced with the challenge of balancing stability, performance and functionality in the face of being first to market and facilitating quick iterations and feature development. 

Ultimately what matters (especially for an early stage start-up) is whether the product idea is good, fits a need in the market, addresses that need in a timely manner and is _just good enough_ to avoid churn and maintain growth. If a company spends all of it's time and money building a perfectly architected, super performant and bug-free app that _nobody uses_, the company may fail. Conversely, if the product solves a real problem or provides sufficient value, often users are prepared to put up with sub-par performance and bugs (within reason of course). Maintaining this context can make it easier to discern whether solving a particular piece of technical debt is really worth it.

There's a conflict though, because technical debt has a tendency to snowball and manifests itself in a buggy and slow products that become increasingly difficult, risky and costly to maintain and iterate upon.

## Prevention is better than cure

In the past I've heard engineers remark "there should be no technical debt as technical debt should be factored in to the planning of the initial task". Whilst an idealistic viewpoint, I would bet everything I own that there is not a single company that has no technical debt whatsoever - it implies having a perfect vision 10 steps ahead when working on new features, whilst spending an inordinate amount of time reworking, improving and polishing existing code as the needs of the business change. It's a great philosophy to strive for, but one that should be balanced against the needs of the business and it's users. Where that balance is stuck is entirely dependent on the context of the company, it's position in the market, it's team, it's product etc.

As engineers working on the product, there's a constant need to discern what's the best solution _immediately_ vs what's going to remain the best solution in a year, two or 10 from now. In start-ups that have a largely unproven product, it's hardly worth considering whether the code written now will remain the same in more than a few years time, as it's incredibly unlikely that the product will remain the same, let alone the code. However, it's incredibly likely that the code written today will be chopped up, re-organised and re-written and that is precisely what engineers should be focused on optimising when architecting the application. In my opinion, this boils down to a few key areas of focus:
