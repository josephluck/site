...
# Every word since 1879 under your fingertips
...
<Gif src="../../static/internote/dictionary.gif" />
...
Following the usability principle [flexibility and efficiency of use](https://www.nngroup.com/articles/ten-usability-heuristics/), I wanted to make the feature even more easily accessible. All good text editors have very well thought out and executed keyboard shortcuts and Internote is no exception! I added shortcuts for `ctrl+d` to open the dictionary and `ctrl+esc` to close it. The full power of the Oxford English Dictionary is truly available under your fingertips!
...
<Gif src="../../static/internote/dictionary2.gif" />
...
<Gif src="../../static/internote/dictionary3.gif" />
